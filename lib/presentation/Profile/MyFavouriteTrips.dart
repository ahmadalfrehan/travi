...
class MyFavouriteTrips extends StatelessWidget {
  const MyFavouriteTrips({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (BuildContext context) => TraviProfileBloc()..myFavouriteTrips(),
      child: Builder(
        builder: (context) {
                      ...
                      Container(
                        ...
                        child: ListView.separated(
                          itemBuilder: (context, index) {
                            return AllTrips(offered:traviProfileBloc.currentTrips[index]);
                          },
                      ...
                      children: [
                        Text(
                          ...
                          style: TextStyle(
                              ...
                              fontWeight: FontWeight.w700,
                              fontSize: MediaQuery.of(context).size.width < 355
                                  ? 10
                                  : 22),
                        ),
                        InkWell(
                          onTap: () {
                            TraviCubit.get(context).likeTrip(offered.id as int);
                          },
                          child: Icon(
                            Icons.favorite,
